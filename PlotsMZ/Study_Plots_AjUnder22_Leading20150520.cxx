	...
	int Study_Plots_AjUnder22_Leading20150520(int i=0)
	{
	...
	fout_inc = new TFile("PbPb_AjUnder22_Correlations.root","RECREATE"); // The output file
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Clone((TString) ("Signal_"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_" +TrkPtBin_strs[ibin3+1]));
...
//return 6;
		...
		cc7->cd(4*(ibin3+1)-ibin);
			...
			hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Draw("LEGO2");	
			hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Clone((TString) ("Yield_"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_" +TrkPtBin_strs[ibin3+1]));
...
//return 26;
		...
		rlimiteta = result_cc26[ibin][ibin2][ibin3]->GetXaxis()->FindBin(1.5 - 0.0001); 
			...
			//	Signal[ibin][ibin2][ibin3]->SetMaximum(MaxSignal[ibin][ibin3]+30);
				...
				Signal_cc26[ibin][ibin2][ibin3]->SetMarkerStyle(3);
				Signal_cc26[ibin][ibin2][ibin3]->SetLineColor(kBlue);
				//Signal_cc26[ibin][ibin2][ibin3]->Draw();
				SignalMinusRL_cc10[ibin][ibin2][ibin3]->SetMarkerStyle(3);
				SignalMinusRL_cc10[ibin][ibin2][ibin3]->SetLineColor(kRed);
				SignalMinusRL_cc10[ibin][ibin2][ibin3]->Draw();
				Signal_cc26[ibin][ibin2][ibin3]->Draw("same");
