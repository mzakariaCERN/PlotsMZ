	...
	int macro_Plots_AjUnder22_Leading(int i=0)
	{
	...
	TCanvas *cc15 = new TCanvas("cc15", "CC15_MEOverMEO_JetScaled_PhiProj_EtaSide_perEtaperPhi", 0, 0, 1500, 1500);	
	TCanvas *cc16 = new TCanvas("cc16", "CC16_MEOverMEO_JetScaled_EtaProj_PhiNarrow", 0, 0, 1500, 1500);	
	TCanvas *cc17 = new TCanvas("cc17", "CC17_MEOverMEO_JetScaled_EtaProj_PhiNarrow", 0, 0, 1500, 1500);	
	...
	TH2D *SoverME[nCBins][nPtBins][nTrkPtBins];      	       // used to save a clone of hJetTrackSignalBackgroundLeading[][][] and then become the Histo of Signal over ME
...
//return 6;
		...
		cc7->cd(4*(ibin3+1)-ibin);
			...
			hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Draw("LEGO2");
	SoverME[ibin][ibin2][ibin3] =  (TH2D*) hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Clone((TString)("SoverME_"+datalabel+"_"+CBin_strs[ibin]+"_"+CBin_strs[ibin+1]+ "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_"+TrkPtBin_strs[ibin3+1]));
	
			SoverME[ibin][ibin2][ibin3]->Write((TString)("SoverME_"+datalabel+"_"+CBin_strs[ibin]+"_"+CBin_strs[ibin+1]+ "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_"+TrkPtBin_strs[ibin3+1]));	
...
//			hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->Divide(hJetTrackMELeading[ibin][ibin2][ibin3]);
			...
			//		yield_inc_proj[ibin][ibin2][ibin3]->Rebin(4);
					...
					//yield_inc_proj[ibin][ibin2][ibin3]->Scale(EtaBinWidth/1.);   //
					yield_inc_proj[ibin][ibin2][ibin3]->Scale(PhiBinWidth/1.);   //
...
//return 8;
		...
		//		Signal[ibin][ibin2][ibin3]->Rebin(2);
				...
				Signal[ibin][ibin2][ibin3]->Scale(EtaBinWidth/1.);
		...
		//		PhiProj_R[ibin][ibin2][ibin3]->Rebin(4);
				...
				PhiProj_R[ibin][ibin2][ibin3]->Scale(PhiBinWidth/1.);	
				//	if(ibin == 0 && ibin3 == 0)
...
///////////////////////
				...
				hJetTrackMELeading[ibin][ibin2][ibin3]->Draw("LEGO2");
	{
				...
				cc14->SaveAs("cc14_ME_Under22.png");
		...
		//		Signal[ibin][ibin2][ibin3] =    (TH1D*)hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->ProjectionY(Form("Phi_Signal%d%d%d",ibin,ibin2,ibin3),36, 65);	
				Signal[ibin][ibin2][ibin3] =    (TH1D*)hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3]->ProjectionY(Form("Phi_Signal%d%d%d",ibin,ibin2,ibin3),41, 60);	
				Signal[ibin][ibin2][ibin3]->SetMarkerStyle(20);
				Signal[ibin][ibin2][ibin3]->SetMarkerColor(kRed);
				Signal[ibin][ibin2][ibin3]->Rebin(4);
				Signal[ibin][ibin2][ibin3]->Scale(1./4.);
		//		Signal[ibin][ibin2][ibin3]->Scale(EtaBinWidth);
				Signal[ibin][ibin2][ibin3]->GetXaxis()->SetTitle("#Delta#phi");
				//Signal[ibin][ibin2][ibin3]->GetYaxis()->SetTitle("B(#Delta#phi)");
				Signal[ibin][ibin2][ibin3]->GetYaxis()->CenterTitle();
				//Signal[ibin][ibin2][ibin3]->Scale(EtaBinWidth/4.);
				Signal[ibin][ibin2][ibin3]->Scale(1./20.);
				
				Signal[ibin][ibin2][ibin3]->GetYaxis() -> SetTitleOffset(0.9);
				Signal[ibin][ibin2][ibin3]->GetXaxis() -> SetTitleOffset(0.8);
				Signal[ibin][ibin2][ibin3]->GetXaxis()-> SetTitleSize(0.06);
				Signal[ibin][ibin2][ibin3]->GetXaxis()-> SetLabelSize(0.06);
				Signal[ibin][ibin2][ibin3]->GetXaxis() -> SetTitleOffset(0.8);
				Signal[ibin][ibin2][ibin3]->GetXaxis()-> SetTitleSize(0.06);
				Signal[ibin][ibin2][ibin3]->GetYaxis()-> SetTitleSize(0.05);
				Signal[ibin][ibin2][ibin3]->GetXaxis()-> SetLabelSize(0.06);
				Signal[ibin][ibin2][ibin3]->GetYaxis()-> SetLabelSize(0.05);
				Signal[ibin][ibin2][ibin3]->Draw();
			...
			//	PhiProj_R[ibin][ibin2][ibin3]->Scale(EtaBinWidth);
				PhiProj_R[ibin][ibin2][ibin3]->Draw("same");

				//if(ibin == 0 && ibin3 == 0)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(40);
				//if(ibin == 0 && ibin3 == 1)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(7.0);
				//if(ibin == 0 && ibin3 == 2)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(1.8);
				//if(ibin == 0 && ibin3 == 3)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(2.4);

				//
				//if(ibin == 1 && ibin3 == 0)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(25);
				//if(ibin == 1 && ibin3 == 1)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(4.5);
				//if(ibin == 1 && ibin3 == 2)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(1.5);	
				//if(ibin == 1 && ibin3 == 3)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(2.4);

				//
				//if(ibin == 2 && ibin3 == 0)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(12.0);
				//if(ibin == 2 && ibin3 == 1)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(2.6);	
				//if(ibin == 2 && ibin3 == 2)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(1.4);
				//if(ibin == 2 && ibin3 == 3)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(2.4);
				...
				//Signal[ibin][ibin2][ibin3]->SetMaximum(4.5);
				//if(ibin == 3 && ibin3 == 1)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(1.6);
				//if(ibin == 3 && ibin3 == 2)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(1.5);
				//if(ibin == 3 && ibin3 == 3)
				//Signal[ibin][ibin2][ibin3]->SetMaximum(3.6);
				...
				cc15->SaveAs("cc15_MEOverMEO_JetScaled_PhiProj_EtaSide_perEtaperPhi_Leading_Under22.png");
...
hJetTrackSignalBackgroundLeading[ibin][ibin2][ibin3] = (TH2D*)fin->Get((TString)(desc + "_hJetTrackSignalBackgroundLeading"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+ "_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]))->Clone((TString) ("Raw_Yield_"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_" +TrkPtBin_strs[ibin3+1]));
	...
	hJetTrackMELeading[ibin][ibin2][ibin3] = (TH2D*) fin->Get((TString)(desc + "_hJetTrackMELeading"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+ "_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]))->Clone((TString) ("Mixed_Event_"+ CBin_strs[ibin] + "_" + CBin_strs[ibin+1] + "_" + PtBin_strs[ibin2] + "_" + PtBin_strs[ibin2+1]+"_"+TrkPtBin_strs[ibin3]+"_" +TrkPtBin_strs[ibin3+1]));
		...
		me_projeta[ibin][ibin2][ibin3]->Rebin(4);
		me_projeta[ibin][ibin2][ibin3]->Scale(1./4.);
		me_projeta[ibin][ibin2][ibin3]->Fit("flat_fit","0","",-3.,-1.5);
		left_level = flat_fit->GetParameter(0);
		me_projeta[ibin][ibin2][ibin3]->Fit("flat_fit","0","",1.5,3.);
		...
		me_projeta[ibin][ibin2][ibin3]->GetXaxis() -> SetTitleOffset(0.8);
		me_projeta[ibin][ibin2][ibin3]->GetXaxis()-> SetTitleSize(0.06);
		me_projeta[ibin][ibin2][ibin3]->GetYaxis()-> SetTitleSize(0.06);
		me_projeta[ibin][ibin2][ibin3]->GetXaxis()-> SetLabelSize(0.06);
		me_projeta[ibin][ibin2][ibin3]->GetYaxis()-> SetLabelSize(0.05);
		...
		bg_fit[ibin][ibin2][ibin3]->Draw("same");
			
				{
					...
					Jettex->SetNDC();
					Jettex->Draw();
					TLatex *COMtex = new TLatex(0.15, 0.67, COM_label[0]);
					COMtex->SetNDC();
					if(ibin == 3)
					COMtex->Draw();
					TLatex *CMStex = new TLatex(0.15, 0.70, CMS_label[0]);
					...
					if(ibin == 2)
					CMStex->Draw();
					TLatex *Pbtex = new TLatex(0.65, 0.73, Pb_label[0]);
					Pbtex->SetNDC();
					if(ibin == 3)
					Pbtex->Draw();
				}
				...
				cc16->SaveAs("cc16_MEOverMEO_JetScaled_EtaProj_PhiNarrow_Leading_Under22.png");
			...
			SignalMinusRL[ibin][ibin2][ibin3]->SetAxisRange(-1.5, 1.5,"X");
			SignalMinusRL[ibin][ibin2][ibin3]->GetXaxis()->SetRangeUser(-1.5,1.5);	
			SignalMinusRL[ibin][ibin2][ibin3]->GetYaxis()->SetTitle("1/N_{jet} dN/(d#Delta#phi dp_{T})");
		//	SignalMinusRL[ibin][ibin2][ibin3]->GetYaxis()->SetTitleSize(0.06);
			SignalMinusRL[ibin][ibin2][ibin3]->GetYaxis()->CenterTitle();
			SignalMinusRL[ibin][ibin2][ibin3]->GetYaxis()->SetTitleOffset(0.6);
			if(ibin3 == 3)
			SignalMinusRL[ibin][ibin2][ibin3]->Scale(1./4.);			
		//	SignalMinusRL[ibin][ibin2][ibin3]->Scale(1/(3.0 *  Aj[ibin]->GetEntries() * PhiBinWidth));

			if(ibin3==0)	SignalMinusRL[ibin][ibin2][ibin3]->SetMinimum(-1.);
			if(ibin3==0)	SignalMinusRL[ibin][ibin2][ibin3]->SetMaximum(3.);
...

	{
				...
				cc17->SaveAs("cc17_Result_Leading_Under22.png");
	...
	//##//	//				centtex->SetNDC();
	//##//	//				centtex->Draw();
	//##//	//				pttex = new TLatex(0.15,0.83,TrkPtBin_labels[ibin3]);
	//##//	//				pttex->SetNDC();
	//##//	//				pttex->Draw();
	//##//	//			}
	//##//
