	...
	int Study_LevelOne_AjUnder22_Leading_NewJEC_20150520(int i=0)
	{
	...
	TFile *fin = TFile::Open("/home/mzakaria3/Documents/Research/MyGitProject/PlotsMZ/BackUpCode_root_output_AjUnder22_Data2011_Only13_20150520_newJEC/Data2011_Only13_20150531_newJEC_AjUnder22.root");  // The input file
	...
	fout_inc = new TFile("LevelOne_PbPb_AjUnder22_Correlations_20150520_NewJEC.root","RECREATE"); // The output file
	...
	TString AjBin_str[1] = {"Aj < 0.22"};
	//TString AjBin_labels[0] = {"Aj < 0.22"};
...
double level;
			...
			yield_inc_proj[ibin][ibin2][ibin3]->GetYaxis()-> SetLabelSize(0.05);
						...
						
				{
					...
					TLatex *Ajtex = new TLatex(0.73,0.85,AjBin_labels[0]);
					Ajtex->SetNDC();
					Ajtex->Draw();
...
//return 9;
	...
	if(ibin<3){
			...
			pttex_cc3_sub->Draw();
			//TLatex *Ajtex = new TLatex(0.78,0.90,AjBin_labels[0]);
			TLatex *Ajtex_cc3_sub = new TLatex(0.78,0.90,AjBin_labels[0]);
