	...
	int Study_LevelOne_NoAjCut_Leading_NewJEC_20150520(int i=0)
	{
	...
	//TFile *fin = TFile::Open("/home/mzakaria3/Documents/Research/MyGitProject/PlotsMZ/BackUpCode_root_output_NoAjCut_Data2011_Only13_20150431_OriginalJEC/Data2011_Only13_20150431_OriginalJEC_NoAjCut.root");  // The input file

		TFile *fin = TFile::Open("/home/mzakaria3/Documents/Research/MyGitProject/PlotsMZ/BackUpCode_root_output_NoAjCut_Data2011_Only13_20150520_newJEC/Data2011_Only13_20150520_newJEC_NoAjCut.root");  
	...
	//fout_inc = new TFile("LevelOne_PbPb_NoAjCut22_Correlations_20150431_OriginalJEC.root","RECREATE"); // The output file
	fout_inc = new TFile("LevelOne_PbPb_NoAjCut22_Correlations_20150520_NewJEC.root","RECREATE"); // The output file
...
//return 9;
	...
	if(ibin<3){
			...
			pttex_cc3_sub->Draw();
			//TLatex *Ajtex = new TLatex(0.78,0.90,AjBin_labels[1]);
			TLatex *Ajtex_cc3_sub = new TLatex(0.78,0.90,AjBin_labels[1]);
